...
function clinic_register_post_types() {
    ...
    register_post_type('doctors', array(
        'labels' => array(
            'name'               => __('Специалисты', 'clinic-stati-prosche'),
            'singular_name'      => __('Специалист', 'clinic-stati-prosche'),
            'menu_name'          => __('Специалисты', 'clinic-stati-prosche'),
            'name_admin_bar'     => __('Специалист', 'clinic-stati-prosche'),
            'add_new'            => __('Добавить специалиста', 'clinic-stati-prosche'),
            'add_new_item'       => __('Добавить нового специалиста', 'clinic-stati-prosche'),
            'new_item'           => __('Новый специалист', 'clinic-stati-prosche'),
            'edit_item'          => __('Редактировать специалиста', 'clinic-stati-prosche'),
            'view_item'          => __('Просмотреть специалиста', 'clinic-stati-prosche'),
            'all_items'          => __('Все специалисты', 'clinic-stati-prosche'),
            'search_items'       => __('Искать специалистов', 'clinic-stati-prosche'),
            'parent_item_colon'  => __('Родительские специалисты:', 'clinic-stati-prosche'),
            'not_found'          => __('Специалисты не найдены', 'clinic-stati-prosche'),
            'not_found_in_trash' => __('В корзине специалистов не найдено', 'clinic-stati-prosche'),
        ),
        'public'              => true,
